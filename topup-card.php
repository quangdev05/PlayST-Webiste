        ...
        <section class="main">
            <div class="home">
                ...
                <section class="main">
                    ...
                    <button class="tab" onclick="window.location.href='https://www.playst.click/topup-bank'">Ngân
                        hàng</button>
                    <button class="tab rounded-tr-lg"
                        onclick="window.location.href='https://thesieuviet.net/recharge/playst-network'">Thẻ
                        Siêu Việt</button>
            ...
            <form class="form-wrapper" id="napThe">
                ...
                <input type="text" class="form-control" name="gems2" id="gems2" required placeholder="Gems nhận được"
                    readonly />
                <input type="text" class="form-control" name="gems" id="gems" required placeholder="Gems nhận được"
