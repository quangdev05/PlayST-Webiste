...
$tongnap_text = ($tongnap_data) ? $tongnap_data['tongnap'] . 'đ' : '0đ';
?>
...
@font-face {
    ...
    src: url('https://www.playst.click/dist/font/Minecraft.woff2') format('woff2'),
         url('https://www.playst.click/dist/font/Minecraft.woff') format('woff'),
         url('https://www.playst.click/dist/font/Minecraft.ttf') format('truetype'),
         url('https://www.playst.click/dist/font/Minecraft.eot?#iefix') format('embedded-opentype');
}
</style>
  ...
  <canvas id="skin_container"></canvas>
    ...
    <div class="flex flex-row gap-2 user-info">
        <div class="font-medium">Rank: Soon</div>
        <div><?= $_SESSION['rank'] ?></div>
    </div>
<div class="flex flex-row gap-2">
        <div class="basis-1/2 user-info flex flex-col">
          <span class="font-medium">Tổng nạp:</span>
