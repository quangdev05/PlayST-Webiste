...
<body style="background: linear-gradient(90deg, rgba(141,194,111,1) 0%, rgba(118,184,82,1) 50%)">
    <div class="login-page">
      <div class="form">
        <form id="verify" class="login-form">
          <h1>Xác Minh Tài Khoản</h1>
          <p class="message" style="padding-bottom:20px;"><b>Hãy Xác Minh Tài Khoản Bằng Cách Đăng Nhập Vào Server Bằng Tài Khoản Vừa Đăng Kí</b></p>
          <input name="user" type="hidden" placeholder="Tài khoản"/>
